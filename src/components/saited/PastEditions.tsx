...
const editions = [
  {
    year: "2025",
    theme: "Infinite Possibilities, Endless Realities: Science Beyond the Omniverse!",
    guest: "CM Mohan Charan Majhi · ISRO Gaganyatri Group Captain Shubhanshu Shukla",
    participants: "5,000+",
  ...
  },
  {
    year: "2024",
    theme: "TBA",
    guest: "Prince Dance Group (Finale Performance)",
    participants: "5,000+",
    accent: "from-purple-500/30 to-pink-500/20",
  },
  {
    year: "2023",
    theme: "Evolving Perspectives: Navigating the Unseen Paradigms",
    guest: "Shri Athithan Gopalaswamy, Former Director General, DRDO",
    participants: "7,000+",
    schools: "36+",
        ...
        <div className="no-scrollbar mt-12 -mx-6 flex gap-5 overflow-x-auto px-6 pb-4 snap-x snap-mandatory">
          {editions.map((e, i) => (
            <motion.div
              ...
              className="group relative w-[340px] shrink-0 snap-start overflow-hidden rounded-2xl glass p-7 transition-all hover:border-cyan-400/50"
            >
              <div
              ...
              <div className="relative">
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <p className="text-base font-medium leading-snug text-white">{e.theme}</p>
                </div>
                <div className="mt-4 space-y-2">
                  <p className="text-xs uppercase tracking-wider text-white/50">Chief Guest</p>
                  <p className="text-sm text-white/80">{e.guest}</p>
                </div>
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  <div className="inline-flex items-center gap-2 rounded-full bg-black/30 px-3 py-1 text-xs text-cyan-200">
